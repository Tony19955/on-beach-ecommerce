          ...
          return (
            <div className="product-detail-container">
              ...
              <div className="product-detail-details-container">
                <h1 className="product-detail-title main-title">{title}</h1>
                <p className="product-detail-info main-text">{info}</p>
                ...
                <div className="product-detail-btns">
                  <Link to="/">
                    <button className="product-detail-back-btn back-btn">Back to products</button>
                  </Link>                 
                  <button 
                    ...
                    className="product-detail-add-to-cart-btn add-btn">
